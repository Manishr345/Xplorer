...
const footer = () => {
  return (
    <div>
         <div className='flex items-center mt-20 justify-center bg-pink-400 space-x-40 text-xl font-serif tracking-tight pb-5 pr-10 pt-16'
        ...
        <div className='flex text-lg font-mono tracking-tight space-x-16 pr-6 pb-40' style={{backgroundColor: '#F8ECE6'}}>
            <div>
                Email: <br/>
            ...
            <div className='list-none text-lg pl-8'>
                <li>FAQs</li>
                <li>Privacy Policies</li>
                <li>Terms of Services</li>
                <li>About</li>
            </div>
            <div className='flex text-lg pl-16 space-x-3'>
