...
export default function Home() {
  ...
  return (
    <div className='mb-20'>
        ...
        <Panel2/>
        <Panel3/>
        <div className='flex items-center justify-center space-x-40 text-xl mb-5 font-bold pr-10' style={{color: 'rgb(29,69,28)'}}>
            <h1>Contact us</h1>
        ...
        <div className='flex text-lg space-x-16 pr-6'>
            <div>
                Email: <a href='mailto:manishr030405@gmail.com'>manishr030405@gmail.com</a>
                <br/>
                Contact no:<a href='tel:+1234567890'>+1234567890</a>
            </div>
            ...
            <div className='list-none text-lg pl-20'>
                <li>Our Blogs</li>
